package com.scto.mide.term.settings
...
import com.scto.mide.term.ui.screens.settings.InputMode
...
object Settings {
   ...
   var default_night_mode
    ...
    private val DEFAULT_NUMBER_SHORTCUT = com.scto.mide.term.ui.screens.terminal.ShortcutBinding(alt = true, keyCode = android.view.KeyEvent.KEYCODE_1)

    fun getNumberShortcutBinding(): com.scto.mide.term.ui.screens.terminal.ShortcutBinding {
        val raw = Preference.getString(key = "number_shortcut_modifier", default = DEFAULT_NUMBER_SHORTCUT.serialize())
        return com.scto.mide.term.ui.screens.terminal.ShortcutBinding.deserialize(raw)
    }

    fun setNumberShortcutBinding(binding: com.scto.mide.term.ui.screens.terminal.ShortcutBinding) {
    ...
    fun getShortcutBinding(action: com.scto.mide.term.ui.screens.terminal.ShortcutAction): com.scto.mide.term.ui.screens.terminal.ShortcutBinding {
        val raw = Preference.getString(key = action.prefKey, default = action.default.serialize())
        return com.scto.mide.term.ui.screens.terminal.ShortcutBinding.deserialize(raw)
    }

    fun setShortcutBinding(action: com.scto.mide.term.ui.screens.terminal.ShortcutAction, binding: com.scto.mide.term.ui.screens.terminal.ShortcutBinding) {
