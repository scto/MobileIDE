...
data class KeyCombination(
    ...
    fun getDisplayName(): String {
        return buildString {
            if (ctrl) append("${com.scto.mobile.ide.core.main.R.string.ctrl.getString()}-")
            if (shift) append("${com.scto.mobile.ide.core.main.R.string.shift.getString()}-")
            if (alt) append("${com.scto.mobile.ide.core.main.R.string.alt.getString()}-")
