...
fun DefaultLineEnding(modifier: Modifier = Modifier) {
    ...
    PreferenceLayout(label = stringResource(com.scto.mobile.ide.core.main.R.string.line_ending), backArrowVisible = true) {
        var selectedEnding by remember { mutableStateOf(Settings.line_ending) }

        InfoBlock(
            icon = { Icon(imageVector = Icons.Outlined.Warning, contentDescription = null) },
            text = com.scto.mobile.ide.core.main.R.string.line_ending_info.getString(),
        )
