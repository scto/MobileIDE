    ...
    OutlinedTextField(
        ...
        onValueChange = {
            ...
            if (dialogState.lspHost.isBlank()) {
                dialogState.hostError = com.scto.mobile.ide.core.main.R.string.invalid_address.getString()
            }
        },
        label = { Text(stringResource(com.scto.mobile.ide.core.main.R.string.address)) },
        singleLine = true,
    ...
    OutlinedTextField(
        ...
        onValueChange = {
            ...
            if (dialogState.lspPort.isBlank() || portInt == null || portInt !in 0..65535) {
                dialogState.portError = com.scto.mobile.ide.core.main.R.string.invalid_port.getString()
            }
        },
        label = { Text(stringResource(com.scto.mobile.ide.core.main.R.string.port_number)) },
        singleLine = true,
