...
class CopyCommand : EditorCommand() {
    ...
    override fun getLabel(): String = com.scto.mobile.ide.core.main.R.string.copy.getString()

    override fun action(context: EditorActionContext) {
        context.editor.copyText()
    }

    override fun getIcon(): Icon = Icon.ResourceIcon(com.scto.mobile.ide.core.main.R.drawable.copy)
