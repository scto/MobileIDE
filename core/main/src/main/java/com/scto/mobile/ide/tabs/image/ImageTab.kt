package com.scto.mobile.ide.tabs.image
...
import com.scto.mobile.ide.activities.main.session.FileTabState
...
import com.scto.mobile.ide.icons.Photo
        ...
        LaunchedEffect(file) {
            state =
                try {
                    ...
                    ImageState.Error(com.scto.mobile.ide.core.main.R.string.resource_loading_error.getString())
                }
        }
