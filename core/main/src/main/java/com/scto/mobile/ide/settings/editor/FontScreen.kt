...
import com.scto.mobile.ide.theme.LegacyOutfitFontFamily
import com.scto.mobile.ide.theme.generateTypography
...
fun FontScreen(
    ...
    PreferenceLayout(label = stringResource(com.scto.mobile.ide.core.main.R.string.fonts), backArrowVisible = true) {
        warningMessage?.let {
            InfoBlock(
        ...
        PreferenceGroup {
                ...
                rememberLauncherForActivityResult(
                    ...
                    onResult = { uri: Uri? ->
                        runCatching {
                                ...
                                toast(com.scto.mobile.ide.core.main.R.string.font_added.getString())
                            }
                            .onFailure {
            ...
            FontRegistry.fonts.forEach { font ->
                ...
                val defaultSuffix = if (isDefault) " (${com.scto.mobile.ide.core.main.R.string.default_option.getString()})" else ""
                PreferenceTemplate(
                    modifier =
                        ...
                        if (font.isAsset.not() && selectedFontCompose.pathOrAsset != font.pathOrAsset) {
                            IconButton(
                                ...
                                Icon(
                                    ...
                                    contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.delete_font),
                                )
                            }
                        }
                    },
            ...
            PreferenceTemplate(
                ...
                contentModifier = Modifier.fillMaxHeight(),
                title = { Text(fontWeight = FontWeight.Bold, text = stringResource(com.scto.mobile.ide.core.main.R.string.add_font)) },
                description = { Text(text = stringResource(com.scto.mobile.ide.core.main.R.string.add_font_desc)) },
                enabled = true,
                applyPaddings = true,
