                    ...
                    launch {
                        ...
                        val result =
                            snackbarHost.showSnackbar(
                                message = com.scto.mobile.ide.core.main.R.string.lsp_connection_error.getString(),
                                actionLabel = com.scto.mobile.ide.core.main.R.string.manage.getString(),
                                duration = SnackbarDuration.Short,
                            )
                        if (result == SnackbarResult.ActionPerformed) {
                            val activity = XedHost!!
                    ...
                    object : EventHandler.EventListener {
                        ...
                        override fun onShowMessage(messageParams: MessageParams?) {
                            ...
                            when (messageParams.type) {
                                ...
                                MessageType.Warning ->
                                    dialogRes(title = com.scto.mobile.ide.core.main.R.string.warning.getString(), msg = messageParams.message)

                                MessageType.Info ->
                                    dialogRes(title = com.scto.mobile.ide.core.main.R.string.info.getString(), msg = messageParams.message)
