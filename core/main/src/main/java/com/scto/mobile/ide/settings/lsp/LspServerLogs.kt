...
import com.scto.mobile.ide.components.StyledTextField
...
import com.scto.mobile.ide.lsp.MessageSource
import com.scto.mobile.ide.settings.Settings
import com.scto.mobile.ide.settings.debugOptions.LogScreen
...
fun LspServerLogs(server: LspServer, id: String) {
    ...
    val logText =
        instance?.let { buildLogs(server, it, messageType, messageSources) } ?: com.scto.mobile.ide.core.main.R.string.instance_not_found.getString()
    ...
    LogScreen(logText, "Language Server Error Report", "server_logs") {
        ...
        IconButton(onClick = { sourceDropdownExpanded = !sourceDropdownExpanded }) {
            Icon(
                painter = painterResource(com.scto.mobile.ide.core.main.R.drawable.filter),
                contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.filter_options),
            )
            ...
            DropdownMenu(
                ...
                MessageSource.entries.forEach { source ->
                    XedDropdownMenuItem(
                        enabled =
                            source != MessageSource.RPC || Settings.record_rpc,
        ...
        if (isRunning) {
            ...
            IconButton(onClick = { scope.launch { instance.start() } }) {
                Icon(
                    painter = painterResource(com.scto.mobile.ide.core.main.R.drawable.run),
                    contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.run),
                )
            }
        }
        ...
        IconButton(
            ...
            Icon(
                painter = painterResource(com.scto.mobile.ide.core.main.R.drawable.stop),
                contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.stop),
            )
        }
    }
}
