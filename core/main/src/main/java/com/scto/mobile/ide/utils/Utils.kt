...
import com.scto.mobile.ide.filetree.FileTreeViewModel
...
fun copyToClipboard(label: String, text: String, showToast: Boolean = true) {
    ...
    if (showToast) {
        toast(com.scto.mobile.ide.core.main.R.string.copied)
    }
}
...
fun timeAgo(currentTimeMillis: Long, startTimeMillis: Long): String? {
    ...
    if (seconds < 1) return com.scto.mobile.ide.core.main.R.string.time_just_now.getString()

    return when {
        seconds < 60 -> com.scto.mobile.ide.core.main.R.plurals.time_seconds_ago.getQuantityString(seconds, seconds)
        minutes < 60 -> com.scto.mobile.ide.core.main.R.plurals.time_minutes_ago.getQuantityString(minutes, minutes)
        hours < 24 -> com.scto.mobile.ide.core.main.R.plurals.time_hours_ago.getQuantityString(hours, hours)
        else -> com.scto.mobile.ide.core.main.R.plurals.time_days_ago.getQuantityString(days, days)
    }
}
