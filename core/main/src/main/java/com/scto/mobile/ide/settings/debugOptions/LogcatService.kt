...
class LogcatService : Service() {
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle(com.scto.mobile.ide.core.main.R.string.logcat_running.getString())
            .setContentText(com.scto.mobile.ide.core.main.R.string.logcat_running_desc.getString())
            .setSmallIcon(com.scto.mobile.ide.core.main.R.drawable.terminal)
            .setContentIntent(pendingIntent)
            .addAction(NotificationCompat.Action.Builder(null, com.scto.mobile.ide.core.main.R.string.stop.getString(), stopPendingIntent).build())
            .setOngoing(true)
            .build()
    }
}
