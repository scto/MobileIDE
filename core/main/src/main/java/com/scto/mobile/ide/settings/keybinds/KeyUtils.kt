...
data object KeyUtils {
    fun getKeyDisplayName(keyCode: Int): String {
        when (keyCode) {
            ...
            KeyEvent.META_SHIFT_ON -> return com.scto.mobile.ide.core.main.R.string.shift.getString()
            KeyEvent.KEYCODE_CTRL_LEFT,
            KeyEvent.KEYCODE_CTRL_RIGHT,
            KeyEvent.META_CTRL_ON -> return com.scto.mobile.ide.core.main.R.string.ctrl.getString()
            KeyEvent.KEYCODE_ALT_LEFT,
            KeyEvent.KEYCODE_ALT_RIGHT,
            KeyEvent.META_ALT_ON -> return com.scto.mobile.ide.core.main.R.string.alt.getString()
    ...
    fun getKeyIcon(keyCode: Int): Icon {
        return Icon.ResourceIcon(
            when (keyCode) {
                KeyEvent.KEYCODE_SHIFT_LEFT -> com.scto.mobile.ide.core.main.R.drawable.shift
                KeyEvent.KEYCODE_DPAD_DOWN -> com.scto.mobile.ide.core.main.R.drawable.chevron_down
                KeyEvent.KEYCODE_DPAD_UP -> com.scto.mobile.ide.core.main.R.drawable.chevron_up
                KeyEvent.KEYCODE_DPAD_LEFT -> com.scto.mobile.ide.core.main.R.drawable.chevron_left
                KeyEvent.KEYCODE_DPAD_RIGHT -> com.scto.mobile.ide.core.main.R.drawable.chevron_right
                KeyEvent.KEYCODE_DEL -> com.scto.mobile.ide.core.main.R.drawable.backspace
                KeyEvent.KEYCODE_FORWARD_DEL -> com.scto.mobile.ide.core.main.R.drawable.backspace_mirrored
                KeyEvent.KEYCODE_TAB -> com.scto.mobile.ide.core.main.R.drawable.kbd_tab
                else -> com.scto.mobile.ide.core.main.R.drawable.keyboard
            }
        )
    }
