...
fun ExcludeFiles(isDrawer: Boolean) {
    ...
    Scaffold(
        topBar = {
            Column {
                TopAppBar(
                    ...
                    title = {
                        Text(
                            stringResource(if (isDrawer) com.scto.mobile.ide.core.main.R.string.exclude_files_drawer else com.scto.mobile.ide.core.main.R.string.exclude_files_search)
                        )
                    },
        ...
        Column(modifier = Modifier.fillMaxSize().padding(paddingValues)) {
            EditorNotice(
                text = stringResource(com.scto.mobile.ide.core.main.R.string.glob_docs),
                actionButton = {
                    IconButton(
                        onClick = {
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.open),
                        )
                    }
                },
            )
