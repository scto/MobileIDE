...
class DocumentProvider : DocumentsProvider() {
    override fun queryRoots(projection: Array<String>?): Cursor {
        ...
        val applicationName = com.scto.mobile.ide.core.main.R.string.app_name.getString()
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, com.scto.mobile.ide.core.main.R.mipmap.ic_launcher)
        return result
    }
    ...
    private fun includeFile(result: MatrixCursor, docId: String?, file: File?) {
        ...
        row.add(DocumentsContract.Document.COLUMN_ICON, com.scto.mobile.ide.core.main.R.mipmap.ic_launcher)
    }
