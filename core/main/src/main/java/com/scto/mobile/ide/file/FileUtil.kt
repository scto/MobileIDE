...
suspend fun openWith(context: Context, file: FileObject) {
    try {
        ...
        if (intent.resolveActivity(context.packageManager) != null) {
            ...
            Toast.makeText(context, com.scto.mobile.ide.core.main.R.string.cant_handle.getString(), Toast.LENGTH_SHORT).show()
        }
    } catch (e: Exception) {
        e.printStackTrace()
        toast(com.scto.mobile.ide.core.main.R.string.file_open_denied.getString())
    }
}
