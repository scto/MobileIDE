...
import com.scto.mobile.ide.activities.main.session.DocumentState
import com.scto.mobile.ide.activities.main.session.DocumentStateDatabase
import com.scto.mobile.ide.activities.main.session.EditorTabState
import com.scto.mobile.ide.activities.main.session.TabState
import com.scto.mobile.ide.activities.main.ui.searchViewModel
import com.scto.mobile.ide.color.ColorPicker
import com.scto.mobile.ide.components.SingleInputDialog
import com.scto.mobile.ide.editor.intelligent.IntelligentFeatureRegistry
...
import com.scto.mobile.ide.search.FindingsDialog
import com.scto.mobile.ide.settings.Settings
import com.scto.mobile.ide.settings.editor.refreshEditorSettings
import com.scto.mobile.ide.settings.support.handleSupport
import com.scto.mobile.ide.tabs.base.Tab
import com.scto.mobile.ide.utils.errorDialog
import com.scto.mobile.ide.utils.hasBinaryChars
...
open class EditorTab(
    ...
    override val name: String
        get() = com.scto.mobile.ide.core.main.R.string.editor.getString()

    val scope = CoroutineScope(Dispatchers.Default)

    override var title by mutableStateOf(customTitle ?: file?.getName() ?: com.scto.mobile.ide.core.main.R.string.temp_file.getString())
    ...
    private fun BinaryNotice(id: String) {
        EditorNotice(
            stringResource(com.scto.mobile.ide.core.main.R.string.binary_file_notice),
            actionButton = {
                IconButton(onClick = { removeNotice(id) }) {
                    Icon(
                        painter = painterResource(com.scto.mobile.ide.core.main.R.drawable.close),
                        contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.close),
    ...
    private fun EditorConfigNotice(id: String) {
        EditorNotice(
            text = stringResource(com.scto.mobile.ide.core.main.R.string.editorconfig_changed),
            actionButton = {
                TextButton(
                    onClick = {
                        scope.launch(Dispatchers.IO) {
                    ...
                    Text(stringResource(com.scto.mobile.ide.core.main.R.string.apply))
                }
            },
        )
    }
    ...
    private suspend fun write() {
        ...
        withContext(Dispatchers.IO) {
            runCatching {
                if (!file.canWrite()) {
                    errorDialog(com.scto.mobile.ide.core.main.R.string.cant_write)
                    return@withContext
                }
        ...
        key(refreshKey) {
            ...
            Column {
                ...
                if (editorState.showRenameDialog) {
                    SingleInputDialog(
                        title = stringResource(com.scto.mobile.ide.core.main.R.string.rename_symbol),
                        inputLabel = stringResource(com.scto.mobile.ide.core.main.R.string.new_name),
                        ...
                        onInputValueChange = {
                            ...
                            if (editorState.renameValue.isBlank()) {
                                editorState.renameError = com.scto.mobile.ide.core.main.R.string.name_empty_err.getString()
                            }
                        },
                ...
                if (editorState.showJumpToLineDialog) {
                    SingleInputDialog(
                        title = stringResource(com.scto.mobile.ide.core.main.R.string.jump_to_line),
                        inputLabel = stringResource(com.scto.mobile.ide.core.main.R.string.line_number),
                        ...
                        onInputValueChange = {
                            ...
                            when {
                                line == null -> {
                                    editorState.jumpToLineError = com.scto.mobile.ide.core.main.R.string.value_invalid.getString()
                                }
                                ...
                                line > lastLine -> {
                                    editorState.jumpToLineError = com.scto.mobile.ide.core.main.R.string.value_large.getString()
                                }

                                line < 1 -> {
                                    editorState.jumpToLineError = com.scto.mobile.ide.core.main.R.string.value_small.getString()
                                }
    ...
    private suspend fun restoreDocumentState() {
        ...
        val db = DocumentStateDatabase.getDatabase(XedHost!!)
