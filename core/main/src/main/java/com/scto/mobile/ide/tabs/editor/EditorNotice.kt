...
import com.scto.mobile.ide.theme.onWarningSurface
import com.scto.mobile.ide.theme.warningSurface
    ...
    Box(modifier = Modifier.background(MaterialTheme.colorScheme.errorContainer)) {
        Column {
            Row(
                ...
                Icon(
                    painter = painterResource(com.scto.mobile.ide.core.main.R.drawable.error),
                    contentDescription = null,
