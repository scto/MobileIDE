...
import com.scto.mobile.ide.common.XedPackage
import com.scto.mobile.ide.extension.manager.StoreManager
import com.scto.mobile.ide.extension.model.PackageCache
...
class ThemeManager(private val context: Application) : CoroutineScope by CoroutineScope(Dispatchers.IO) {
            ...
            .getOrElse { e ->
                if (e is MissingFieldException) {
                    ...
                    dialogRes(
                        ...
                        com.scto.mobile.ide.core.main.R.string.theme_install_failed.getString(),
                        com.scto.mobile.ide.core.main.R.string.manifest_missing_fields.getFilledString(fields),
                        cancelable = false,
                    )
                    return null
                }
                dialogRes(
                    SettingsActivity.instance,
                    com.scto.mobile.ide.core.main.R.string.theme_install_failed.getString(),
                    e.localizedMessage ?: com.scto.mobile.ide.core.main.R.string.unknown_err.getString(),
                    cancelable = false,
                )
                return null
            }
        ...
        withContext(Dispatchers.IO) {
            ...
            if (manifest.minAppVersion != null && manifest.minAppVersion.toLong() > currentVersionCode) {
                dialogRes(
                    ...
                    title = com.scto.mobile.ide.core.main.R.string.warning.getString(),
                    msg = com.scto.mobile.ide.core.main.R.string.incompatible_theme_warning.getString(),
                    cancelRes = com.scto.mobile.ide.core.main.R.string.cancel,
    ...
    private suspend fun migrateOldThemes(themeDir: File) {
        ...
        listFiles?.forEach { file ->
            if (file.isFile) {
                runCatching {
                    if (migratedCount == 0) {
                        withContext(Dispatchers.Main) {
                            toast(com.scto.mobile.ide.core.main.R.string.migrating_themes.getString())
                        }
                    }
        ...
        if (migratedCount > 0) {
            withContext(Dispatchers.Main) {
                toast(com.scto.mobile.ide.core.main.R.string.theme_migrated.getFilledString(migratedCount))
            }
        }
    }
