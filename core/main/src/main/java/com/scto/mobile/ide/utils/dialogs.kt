...
fun errorDialog(
    ...
    title: String = com.scto.mobile.ide.core.main.R.string.error.getString(),
    msg: String,
) {
...
fun dialogRes(
    ...
    title: String? = null,
    msg: String,
    @StringRes cancelRes: Int = com.scto.mobile.ide.core.main.R.string.cancel,
    @StringRes okRes: Int = com.scto.mobile.ide.core.main.R.string.ok,
...
fun dialog(
    ...
    title: String? = null,
    msg: String,
    cancelText: String = com.scto.mobile.ide.core.main.R.string.cancel.getString(),
    okText: String = com.scto.mobile.ide.core.main.R.string.ok.getString(),
    onOk: (AlertDialog?) -> Unit = {},
    onCancel: ((AlertDialog?) -> Unit)? = null,
    cancelable: Boolean = true,
) {
    if (activity == null) {
        toast(com.scto.mobile.ide.core.main.R.string.unknown_error)
        return
    }
