...
import com.scto.mobile.ide.events.LSPEvent
...
import com.scto.mobile.ide.tabs.editor.applyHighlightingAndConnectLSP
import com.scto.mobile.ide.theme.greenStatus
import com.scto.mobile.ide.theme.yellowStatus
...
fun LspServerInstance.getStatusText(): String {
    return when {
        status == LspConnectionStatus.CRASHED -> stringResource(com.scto.mobile.ide.core.main.R.string.status_crashed)
        status == LspConnectionStatus.TIMEOUT -> stringResource(com.scto.mobile.ide.core.main.R.string.status_timeout)
        hasError -> stringResource(com.scto.mobile.ide.core.main.R.string.error)
        status == LspConnectionStatus.STARTING -> stringResource(com.scto.mobile.ide.core.main.R.string.status_starting)
        status == LspConnectionStatus.RESTARTING -> stringResource(com.scto.mobile.ide.core.main.R.string.status_restarting)
        status == LspConnectionStatus.RUNNING -> stringResource(com.scto.mobile.ide.core.main.R.string.status_running)
        status == LspConnectionStatus.STOPPING -> stringResource(com.scto.mobile.ide.core.main.R.string.status_stopping)
        DefinitionPrevention.isServerPrevented(
            lspProject,
            server,
        ) -> stringResource(com.scto.mobile.ide.core.main.R.string.status_not_running_forced)

        else -> stringResource(com.scto.mobile.ide.core.main.R.string.status_not_running)
    }
}
    ...
    when {
        status == LspConnectionStatus.CRASHED || status == LspConnectionStatus.TIMEOUT || hasError -> {
            Icon(
                ...
                contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.error),
        ...
        status == LspConnectionStatus.RUNNING -> {
            Icon(
                ...
                contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.status_running),
