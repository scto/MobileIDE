                ...
                Column(Modifier.weight(1f).fillMaxWidth()) {
                    Row(modifier = Modifier.fillMaxWidth()) {
                        ...
                        StyledTextField(
                                        ...
                                        XedDropdownMenuItem(
                                            text = {
                                                Row(verticalAlignment = Alignment.CenterVertically) {
                                                    ...
                                                    Spacer(Modifier.width(12.dp))
                                                    Text(stringResource(com.scto.mobile.ide.core.main.R.string.regex))
                                                    Spacer(Modifier.width(8.dp))
                                                }
                                            },
                                            onClick = {
                                        ...
                                        XedDropdownMenuItem(
                                            text = {
                                                Row(verticalAlignment = Alignment.CenterVertically) {
                                                    ...
                                                    Spacer(Modifier.width(12.dp))
                                                    Text(stringResource(com.scto.mobile.ide.core.main.R.string.whole_word))
                                                    Spacer(Modifier.width(8.dp))
                                                }
                                            },
                                            onClick = {
                            ...
                            placeholder = { Text(stringResource(com.scto.mobile.ide.core.main.R.string.search)) },
                            keyboardOptions =
                                KeyboardOptions(
                                    imeAction =
                                        if (editorState.isReplaceShown && editorState.editable) {
                    ...
                    if (editorState.isReplaceShown && editorState.editable) {
                        Row(Modifier.fillMaxWidth()) {
                            ...
                            StyledTextField(
                                ...
                                shape = RoundedCornerShape(8.dp),
                                placeholder = { Text(stringResource(com.scto.mobile.ide.core.main.R.string.replace)) },
            ...
            Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
                Row(
                    ...
                    TextButton(
                        ...
                        onClick = {
                            runCatching { editor.get()?.searcher?.gotoPrevious() }
                                .onFailure {
                                    logError(it)
                                    toast(com.scto.mobile.ide.core.main.R.string.unknown_err)
                                }
                        },
                    ) {
                        Text(stringResource(com.scto.mobile.ide.core.main.R.string.go_prev).uppercase())
                    }
                    ...
                    TextButton(
                        ...
                        Text(stringResource(com.scto.mobile.ide.core.main.R.string.go_next).uppercase())
                    }
                    ...
                    if (editorState.isReplaceShown && editorState.editable) {
                        TextButton(
                            ...
                            Text(stringResource(com.scto.mobile.ide.core.main.R.string.replace).uppercase())
                        }
                        ...
                        TextButton(
                            ...
                            Text(stringResource(com.scto.mobile.ide.core.main.R.string.replace_all).uppercase())
                        }
                    }
                }
