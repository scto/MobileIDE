    ...
    PreferenceScaffold(
        ...
        fab = {
            ExtendedFloatingActionButton(
                ...
                icon = { Icon(painter = painterResource(com.scto.mobile.ide.core.main.R.drawable.extension), contentDescription = null) },
                text = { Text(stringResource(com.scto.mobile.ide.core.main.R.string.browse_extensions)) },
            )
        },
    ) { paddingValues ->
                ...
                LazyColumn(
                    ...
                    item {
                        InfoBlock(
                            ...
                            text = stringResource(com.scto.mobile.ide.core.main.R.string.info_formatters),
        ...
        PreferenceTemplate(
            ...
            title = {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Icon(
                        imageVector = ImageVector.vectorResource(com.scto.mobile.ide.core.main.R.drawable.drag_indicator),
                    ...
                    XedIcon(
                        icon = formatter.icon ?: Icon.ResourceIcon(com.scto.mobile.ide.core.main.R.drawable.auto_fix),
        ...
        PreferenceTemplate(
            ...
            title = {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    XedIcon(
                        icon = Icon.ResourceIcon(com.scto.mobile.ide.core.main.R.drawable.server),
                        modifier = Modifier.padding(end = 8.dp).size(20.dp),
                        contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.language_server),
                    )

                    Column {
                        Row {
                            Text(
                                text = stringResource(com.scto.mobile.ide.core.main.R.string.language_server),
                                style = MaterialTheme.typography.bodyLarge,
                            )
                        }
                        Text(
                            text = stringResource(com.scto.mobile.ide.core.main.R.string.formatter_lsp_desc),
                            maxLines = 1,
                            overflow = TextOverflow.Ellipsis,
                            fontSize = 12.sp,
                            color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.7f),
