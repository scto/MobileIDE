...
import com.scto.mobile.ide.components.ContentProgress
...
object FileOperations {
    ...
    fun saveAs(file: FileObject) {
        to_save_file = file
        XedHost?.fileManager?.requestOpenDirectoryToSaveFile(file)
    }
    ...
    fun addFile(parentFile: FileObject) {
        ...
        intent.type = "*/*"
        XedHost?.fileManager?.requestAddFile(parentFile)
    }
