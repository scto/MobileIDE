package com.scto.mobile.ide.settings.keybinds
...
import com.scto.mobile.ide.components.compose.preferences.base.PreferenceLayoutLazyColumn
...
import com.scto.mobile.ide.theme.Typography
...
fun KeybindingsScreen() {
    ...
    PreferenceLayoutLazyColumn(
        label = stringResource(id = com.scto.mobile.ide.core.main.R.string.keybindings),
        ...
        item { InfoBlock(text = stringResource(id = com.scto.mobile.ide.core.main.R.string.keybinds_info)) }
            ...
            SearchBarDefaults.InputField(
                ...
                trailingIcon = {
                    IconButton({ searchQuery.clearText() }) {
                        Icon(imageVector = Icons.Rounded.Close, contentDescription = stringResource(com.scto.mobile.ide.core.main.R.string.close))
                    }
                },
                onSearch = {},
                expanded = false,
                onExpandedChange = {},
                placeholder = {
                    Text(stringResource(com.scto.mobile.ide.core.main.R.string.search_keybinds), maxLines = 1, overflow = TextOverflow.Ellipsis)
                },
            )
        }
...
fun KeybindItem(
    ...
    PreferenceTemplate(
        ...
        endWidget = {
            Text(
                text = keyCombination?.getDisplayName() ?: stringResource(com.scto.mobile.ide.core.main.R.string.none_set),
...
fun EditKeybindsDialog(command: Command, onSubmit: (KeyCombination?) -> Unit, onDismiss: () -> Unit) {
    val noneSetText = stringResource(com.scto.mobile.ide.core.main.R.string.none_set)
    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                Text(text = stringResource(com.scto.mobile.ide.core.main.R.string.press_key))
                TextField(
                    modifier =
                    ...
                    supportingText =
                        if (hasConflict) {
                            {
                                Text(
                                    text = stringResource(com.scto.mobile.ide.core.main.R.string.keybindings_conflict_error),
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(stringResource(com.scto.mobile.ide.core.main.R.string.ctrl))
                    ...
                    Text(stringResource(com.scto.mobile.ide.core.main.R.string.shift))
                    ...
                    Text(stringResource(com.scto.mobile.ide.core.main.R.string.alt))
                }
            }
        },
        confirmButton = {
