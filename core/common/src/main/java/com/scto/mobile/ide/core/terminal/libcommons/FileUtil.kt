package com.scto.mobile.ide.core.terminal.libcommons
...
private fun getFilesDir(): File{
    return if (application == null){
        if (BuildConfig.DEBUG){
            File("/data/data/com.scto.mobile.ide.core.terminal.app.debug/files")
        }else{
            File("/data/data/com.scto.mobile.ide.core.terminal.app/files")
        }
    }else{
