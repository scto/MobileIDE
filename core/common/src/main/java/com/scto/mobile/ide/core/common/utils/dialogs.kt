...
fun errorDialog(activity: Activity? = com.scto.mobile.ide.utils.currentActivity.get(), title: String = strings.error.getString(), msg: String) {
...
fun errorDialog(
    activity: Activity? = com.scto.mobile.ide.utils.currentActivity.get(),
    throwable: Throwable,
