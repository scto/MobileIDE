...
/**
 * Holt einen String sicher. Falls die Application nicht initialisiert wurde,
 * wird eine leere Zeichenkette zurückgegeben oder eine Exception geworfen.
 */
 ...
 * anstatt eine NullPointerException zu provozieren.
 */
