package com.scto.mobile.ide.json_lsp
...
class Main(context: ExtensionContext) : ExtensionAPI(context) {
    ...
    var jsonServer: JsonServer? = null
    ...
    override fun onExtensionLoaded() {
        ...
        val binPath = File(pluginPath).child("bin").child(arch).child("light-json-lsp")

        jsonServer = JsonServer(binPath.absolutePath).also {
