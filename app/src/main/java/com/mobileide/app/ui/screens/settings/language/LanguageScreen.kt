package com.mobileide.app.ui.screens.settings.language
...
@Composable
fun LanguageScreen(vm: IDEViewModel) {
    Scaffold(
        topBar = { SettingsTopBar("Sprache", onBack = { vm.navigate(Screen.SETTINGS) }) },
