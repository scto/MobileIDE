package com.mobileide.app.ui.screens.settings.lsp
...
@Composable
fun LspScreen(vm: IDEViewModel) {
    val servers = listOf("bash", "css", "html", "json", "markdown", "python", "typescript", "xml")
    Scaffold(
        topBar = { SettingsTopBar("Sprachserver", onBack = { vm.navigate(Screen.SETTINGS_EDITOR) }) },
