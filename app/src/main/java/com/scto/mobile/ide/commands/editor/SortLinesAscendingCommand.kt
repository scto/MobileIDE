...
class SortLinesAscendingCommand : EditorCommand() {
    override val id: String = "editor.sortlinesascending"
    override val title: String = "sortlinesascending"
    override suspend fun executeEditorCommand(context: MobileIDECommandContext, tab: CodeEditorState, editor: CodeEditor) {
        withContext(Dispatchers.Main) {
            Toast.makeText(context.androidContext, "SortLinesAscendingCommand not implemented yet", Toast.LENGTH_SHORT).show()
        }
    }
}
