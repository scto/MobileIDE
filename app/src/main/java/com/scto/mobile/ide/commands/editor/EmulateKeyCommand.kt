    ...
    override val childCommands: List<Command> by lazy {
        ...
        metaEvents.map { metaEvent ->
            ...
            object : EditorCommand(), ToggleableCommand {
                ...
                override val title: String = keyDisplayName
                ...
                override val icon: Any? = null // keyIcon
