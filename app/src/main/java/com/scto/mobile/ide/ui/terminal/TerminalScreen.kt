...
fun TerminalScreen(navController: NavController) {
    ...
    Scaffold(
        modifier = Modifier
            .fillMaxSize()
            // Only handle left and right safe areas, top and bottom are handled by topBar/bottomBar
        ...
        topBar = {
            Column(
                modifier = Modifier
                    ...
                    .statusBarsPadding() // 1. Ensure to avoid status bar
            ) {
                // 1. Title bar
                TopAppBar(
                    title = {
                ...
                // 2. Tabs + Add Button
                // 🔥 As per your request:
                // 1. Set fixed height (45dp) to prevent taking up too much space
                // 2. Remove CenterVertically, change to Bottom (bottom alignment), close to the divider
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(45.dp),
                        ...
                        SecondaryScrollableTabRow(
                            ...
                            indicator = {
                                TabRowDefaults.SecondaryIndicator(
                                    ...
                                    height = 3.dp, // Indicator slightly thicker, clearer
                            ...
                            SessionManager.sessions.forEachIndexed { index, session ->
                                ...
                                Tab(
                                    ...
                                    Row(
                                        ...
                                        // Add a little padding to adjust left/right and bottom spacing
                    ...
                    VerticalDivider(
                        modifier = Modifier
                            .padding(vertical = 10.dp) // Top and bottom padding
                            .height(20.dp),
                        color = MaterialTheme.colorScheme.outlineVariant
                    )

                    // Add button
                    // Because Row is bottom aligned, button might sink to the bottom.
                    // Here we make the button slightly centered to look comfortable, or just let it sink
                    Box(
                        modifier = Modifier
        ...
        bottomBar = {
            Surface(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .imePadding() // Ensure it is pushed up by the input method
            ) {
                                    ...
                                    factory = { ctx ->
                                        EditText(ctx).apply {
                                            ...
                                            doOnTextChanged { t, _, _, _ ->
                                                ...
                                                text = "" // Clear input box, prepare for next input
                                            }
        ...
        // 🔥🔥🔥 The innerPadding here is very critical! It contains the TopBar height.
        // If padding is not added here, TopBar will directly cover the terminal.
        if (currentSession != null) {
            Box(
                modifier = Modifier
                    .fillMaxSize()
                    .padding(innerPadding) // Must apply the Padding passed by Scaffold
