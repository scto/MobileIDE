package com.mobileide.feature.settings.debugOptions
...
@Composable
fun DebugOptionsScreen(onBack: () -> Unit, onNavigate: (String) -> Unit = {}) {
    ...
    Scaffold(
        topBar = { SettingsTopBar("Debug-Optionen", onBack = { onNavigate("SETTINGS") }) },
