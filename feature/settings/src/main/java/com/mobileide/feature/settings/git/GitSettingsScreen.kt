package com.mobileide.feature.settings.git
...
@Composable
fun GitSettingsScreen(onBack: () -> Unit, onNavigate: (String) -> Unit = {}) {
    ...
    Scaffold(
        topBar = { SettingsTopBar("Git", onBack = { onNavigate("SETTINGS") }) },
