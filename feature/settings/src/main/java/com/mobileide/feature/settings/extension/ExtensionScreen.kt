package com.mobileide.feature.settings.extension
...
@Composable
fun ExtensionScreen(onBack: () -> Unit, onNavigate: (String) -> Unit = {}) {
    Scaffold(
        topBar = { SettingsTopBar("Erweiterungen", onBack = { onNavigate("SETTINGS") }) },
