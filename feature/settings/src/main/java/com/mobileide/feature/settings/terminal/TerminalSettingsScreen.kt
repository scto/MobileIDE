package com.mobileide.feature.settings.terminal
...
@Composable
fun TerminalSettingsScreen(onBack: () -> Unit, onNavigate: (String) -> Unit = {}) {
    ...
    Scaffold(
        topBar = { SettingsTopBar("Terminal", onBack = { onNavigate("SETTINGS") }) },
